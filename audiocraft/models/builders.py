...
def get_lm_model(cfg: omegaconf.DictConfig) -> LMModel:
    ...
    if cfg.lm_model == 'transformer_lm':
        ...
        # 1. 获取条件融合器 (ConditionFuser) 和条件提供器 (ConditioningProvider)
        #    这些模块负责处理文本、音频等非视频的条件信息。
        ...
        # 2. == 实例化 LMModel，并注入视频相关参数 ==
        #    这是 VidMuse 项目的核心创新点所在。
        return LMModel(
            ...
            audio_encoder=cfg.model.audio_encoder, # 假设配置路径是 model.audio_encoder
